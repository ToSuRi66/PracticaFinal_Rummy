...
public class ReglesRummyKub implements ReglesJoc{
	...
	@Override public int getNUM_BARALLES() { return 2; } // 106 fitxes = 2 baralles + 2 joquers
	@Override public int getNUM_JUGADORS_MAXIM() { return 4; }
	...
	@Override public boolean getPermetManipularTaula() { return true; } // ÚNIC JOC AMB TRUE
	@Override public boolean getPermetBaixarCombinacions() { return true; }
	@Override public boolean getObligatoriDescartarAFinalDeTorn() { return false; } // Al Kub no es descarta
