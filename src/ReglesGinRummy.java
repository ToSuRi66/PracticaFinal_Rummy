...
public class ReglesGinRummy implements ReglesJoc{
	...
	@Override public int getPUNTS_MINIM_OBERTURA() { return 0; }
	@Override public boolean getPERMET_JOQUERS() { return false; }
	@Override public int getNUM_BARALLES() { return 1; }
	@Override public int getNUM_JUGADORS_MAXIM() { return 2; }
